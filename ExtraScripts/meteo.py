...
URL_QUERY = "https://api.sunrise-sunset.org/json?lat=51.5072&lng=0.1276"
...
#                                               debug_print(temp_sunrise)
						debug_print("Sunrise: " + sunrise)
#                                               debug_print(temp_sunset)
						debug_print("Sunset: " + sunset)
						...
						if(sunrise_offset > 0):
								debug_print("Lights OFF at: " + sunrise_str + " +" + str(sunrise_offset) + " minutes")
						else:
								debug_print("Ligths OFF at: " + sunrise_str + " " + str(sunrise_offset) + " minutes")

						if(sunset_offset > 0):
								debug_print("Lights ON at: " + sunset_str + " +" + str(sunset_offset) + " minutes")
						else:
								debug_print("Lights ON at: " + sunset_str + " " + str(sunset_offset) + " minutes")
					...
					debug_print("Sunset Sunrise times update fail.")
		...
		debug_print("    ON time: " + sunset_with_ofst.strftime('%H:%M:%S'))
		debug_print("    DIM time: " + dim_time.strftime('%H:%M:%S'))
		debug_print("    OFF time: " + sunrise_with_ofst.strftime('%H:%M:%S'))
